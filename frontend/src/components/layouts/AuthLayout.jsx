...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      <div className="w-screen h-screen md:w-[60vw] flex flex-col items-start justify-center px-12 pt-8 pb-12">
        <h1 className="text-3xl font-bold text-black mt-6 mb-8 tracking-wide text-center">FinTrack</h1>
        {children}
      </div>
