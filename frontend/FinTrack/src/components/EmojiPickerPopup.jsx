    ...
    <div className="flex flex-col md:flex-row items-start gap-5 mb-6">
      ...
      {isOpen && (
        <div className="relative">
            <button className="w-7 h-7 flex items-center justify-center text-black bg-white border border-gray-200 rounded-full absolute -top-2 -right-2 z-10 cursor-pointer shadow" onClick={() => setIsOpen(false)}>
                <LuX />
            </button>
